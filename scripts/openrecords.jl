...
binfile = "D:/INCART/Pulse_Data/bin/PX113211027165348.bin" 
pls = "C:/ktiflg/export/PX113211027165348.pls"
ton = "C:/ktiflg/export/PX113211027165348.ton"
...
scatter!(presPe, segmP[presPe]*1000, markersize = 2)
xlims!(5000, 6000)
ylims!(100000, 120000)

plot(segmT)
scatter!(tonePb, segmT[tonePb], markersize = 2)
